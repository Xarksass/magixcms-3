 ...
 *
 */
class component_core_smarty extends Smarty {
    /**
    ...
    /**
     * component_core_smarty constructor.
     */
    ...
    protected function setParams(){
        ...
        $this->setConfigDir(array(
            $this->setPath()."locali18n/",
            $this->setPath()."skin/" . $this->template->theme . '/i18n/'
        ));
        ...
        $this->setTemplateDir(array(
            $this->setPath()."skin/".$this->template->theme.'/'
        ));
    ...
    /**
     * @return component_core_smarty
     */
    public static function getInstance(){
        if (!isset(self::$instance))
        {
            self::$instance = new component_core_smarty();
        }
