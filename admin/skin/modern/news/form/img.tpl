...
<div class="row">
	<div class="col-12 img-settings">
		<fieldset>
			...
			{include file="form/brick/dropzone.tpl" type='img' ratio=1.618 multiple=false src=$page.imgSrc id=$page.id_news name='img' folder='news' progressbar=false submit=false delete=(isset($page.img_news))}
			<p class="help-block">
	...
	<div class="col-12 img-preview">
		<fieldset>
			...
			<div class="block-img">
				{if $page.imgSrc != null}
					{include file="form/loop/img.tpl" controller="news" data=['id' => $page.id_news, 'imgSrc' => $page.imgSrc]}
				{/if}
			</div>
		</fieldset>
	</div>
