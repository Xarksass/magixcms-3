<div class="text-center">
    <i class="material-icons">copyright</i> 2008{if 'Y'|date != '2008'} - {'Y'|date}{/if}
    ...
    <ul class="list-inline">
        <li><a href="https://www.facebook.com/magix.cms" title="Facebook" class="targetblank"><span class="fab fa-facebook-f"></span><span class="sr-only">Facebook</span></a></li>
