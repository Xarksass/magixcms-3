...
<div class="row">
	<div class="col-12 img-settings">
		<fieldset>
			...
			{include file="form/brick/dropzone.tpl" type='img' ratio=1.618 multiple=false src=$page.imgSrc id=$page.id_cat name='img' folder='catalog/c' progressbar=false submit=false delete=(isset($page.img_cat))}
			<p class="help-block">
	...
	<div class="col-12 img-preview">
		<fieldset>
			...
			<div class="block-img">
				{if $page.imgSrc != null}
					{include file="form/loop/img.tpl" controller="category" uploadDir="catalog/c" data=['id' => $page.id_cat, 'imgSrc' => $page.imgSrc]}
				{/if}
			</div>
		</fieldset>
	</div>
