...
{block name="head:script"}category/mc_cat.js{/block}
                ...
                <div class="tab-content">
                    ...
                    <fieldset role="tabpanel" class="tab-pane{if $iso@first} active{/if}" id="page-lang-{$id}">
                        ...
                        <div class="form-group">
                            <div id="{$iso['iso']}cat" class="btn-group btn-block selectpicker" data-clear="true" data-live="true">
                            ...
                            <input type="hidden" name="{$iso['iso']}cat_id" id="{$iso['iso']}cat_id" class="form-control cat_id" value="" data-lang="{$iso['iso']}"/>
                        </div>
                    </fieldset>
                    {/foreach}
                </div>
            </form>
            <form id="cat-link" action="#" method="post" class="validate_form collapse">
                <div class="form-group">
