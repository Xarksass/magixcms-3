...
{block name="head:script"}product/mc_product.js{/block}
                ...
                <div class="tab-content">
                    ...
                    <fieldset role="tabpanel" class="tab-pane{if $iso@first} active{/if}" id="page-lang-{$id}">
                        ...
                        <div class="form-group">
                            <div id="{$iso['iso']}product" class="btn-group btn-block selectpicker" data-clear="true" data-live="true">
                            ...
                            <input type="hidden" name="{$iso['iso']}product_id" id="{$iso['iso']}product_id" class="form-control product_id" value="" data-lang="{$iso['iso']}"/>
                        </div>
                    </fieldset>
                    {/foreach}
                </div>
            </form>
            <form id="product-link" action="#" method="post" class="validate_form collapse">
                <div class="form-group">
