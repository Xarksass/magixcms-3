                ...
                submitHandler: function(f,e) {
                    ...
                    $.jmRequest({
                        ...
                        beforeSend:function(){
                            ...
                            $(f).hide().after('<div class="svg-loader text-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="25 25 50 50">\n' +
                        ...
                        success:function(d){
                            if(d.status) {
                                ...
                                //$(f).html(form);
                                //$this.initLoginForm();
                                //if(niceForms) niceForms.reset();
                                f.reset();
                                if(niceForms !== undefined) niceForms.reset();
                                $(f).show();
                                $('.svg-loader').remove();
                                $('.flip-container').prepend(d.notify);
                            }
                        }
                    });
                    return false;
