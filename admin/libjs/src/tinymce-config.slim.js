;(function ( $, window, document, undefined ) {
    ...
    $('.mceEditor').tinymce({
        ...
        entity_encoding : "raw",
        plugins: [
            'hr advlist autolink lists link image lazyloadimage charmap print preview anchor',
            'searchreplace visualblocks code fullscreen colorpicker textpattern wordcount directionality',
            'insertdatetime media table contextmenu paste textcolor template youtube imagetools codesample responsivefilemanager mc_pages mc_cat mc_product mc_news'
        ],
        toolbar1: 'fullscreen | code | removeformat | formatselect | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | link unlink | bullist numlist | blockquote | loremipsum |',
        imagetools_toolbar: "imageoptions",
        menu : {
            file   : {title : 'File'  , items : 'newdocument'},
            edit   : {title : 'Edit'  , items : 'undo redo | cut copy paste pastetext | selectall'},
            insert : {title : 'Insert', items : 'link mc_pages mc_cat mc_product mc_news anchor | responsivefilemanager image media youtube | template | table | hr'},
